...
export const sampleCapture: CaptureEvent[] = [
  ...
  { id: "evt-002", at: "2026-08-15T10:00:02.000Z", type: "interaction", kind: "input", selector: "#email", selectorConfidence: "high", fieldName: "email", value: "ada@example.test", url: "http://localhost:4173/" },
  { id: "evt-003", at: "2026-08-15T10:00:03.000Z", type: "interaction", kind: "input", selector: "#password", selectorConfidence: "high", fieldName: "password", value: "correct-horse-battery-staple", url: "http://localhost:4173/?token=secret-token" },
  { id: "evt-004", at: "2026-08-15T10:00:04.000Z", type: "interaction", kind: "click", selector: "#checkout", selectorConfidence: "high", url: "http://localhost:4173/" },
